  ...
  methods: {
    drawLine(){
        ...
        var geoCoordMap = {
                ...
                "大连市沙河口区星海广场B2区18号, 大连, LIAONING, 116021":[121.62,38.92],
                ...
                "重庆市九龙坡区红狮西路3号东南70米，重庆市，404100":[106.499796,29.592867],
                "西宁市城东区经济技术开发区昆仑东路6号，西宁市，810000":[101.796806,36.622292],
                "台湾省嘉义县太保市北港路二段177号，台湾":[121.082411,23.772756]
            };
            ...
            var option = {
                ...
                tooltip: {
                    ...
                    formatter: function (params) {
                        ...
                        return '<h1 style="color:#000;">'+leadName +' highCar 4S点</h1><br/>'+params.name  + '<br/>电话：' + params.value[2]  ;
                    }
                },
                legend: {
                    orient: 'vertical',
                ...
                series: [{
                    ...
                    data: convertData([
                        ...
                        {name: "大连市沙河口区星海广场B2区18号, 大连, LIAONING, 116021", value:13333333333,symbolSize: 15},
                        ...
                        {name: "重庆市九龙坡区红狮西路3号东南70米，重庆市，404100",value:13333333333, symbolSize: 15},
                        {name: "西宁市城东区经济技术开发区昆仑东路6号，西宁市，810000",value:13333333333, symbolSize: 15},
                        {name: "台湾省嘉义县太保市北港路二段177号，台湾",value:13333333333, symbolSize: 15},
                    ]),
                    itemStyle: {
                        normal: {
                            color: function(e){
